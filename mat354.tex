...
\begin{theorem}[Argument Principle]
    ...
    The \bluebf{argument principle} states $f(z)$ is a non-constant meromorphic function in an open set $\Omega.$ Let $K\subset\Omega$ be a compact set with oriented boundary $\Gamma.$ Given $a,$ assume there are no zeros of $f(z)-a$ and no poles of $f(z)$ on $\Gamma.$ Then, \begin{align}
...
\begin{theorem}[Runge's Approximation]
