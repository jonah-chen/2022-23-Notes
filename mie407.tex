...
\begin{itemize}
    ...
    \end{equation}
    \item The magnitude of vector flux density is the combined distance traveled by these neutrons. The \bluebf{scalar neutron flux},\begin{equation}
        \Phi(\mathbf r,E)=\int_{4\pi}\mathbf\phi(\mathbf r, E,\mathbf\Omega)\dd\Omega=v\int_{4\pi}n(\mathbf r, E,\mathbf\Omega)\dd\Omega.
    \end{equation}
    \item The \bluebf{neutron current density} is\begin{equation}
